<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Choose wisely, ') }}{{ Auth::user()->firstname }}{{ __('!') }}
        </h2>
    </x-slot>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center justify-between border-b border-gray-300 py-2">
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-gray-500">Price: {{ $item->price }} credits</p>
                            </div>
    ...
    <div id="purchase-feedback" class="fixed inset-0 z-50 flex items-center justify-center hidden">
        <div class="bg-white p-6 rounded shadow-lg">
            <div id="feedback-text" class="text-lg font-semibold text-gray-900"></div>
            <button id="close-feedback" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:border-blue-900 focus:ring ring-blue-300 transition ease-in-out duration-150">
                Close
            </button>
        </div>
    </div>
